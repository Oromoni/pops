...
const Hero = () => {
  return (
    <>
      <div className=" p-2 bg-black" id="About">
        <div className="text-white bg-black p-5 sm:flex sm:flex-row sm:gap-6 mt-4">
          ...
          <p className="mt-2 sm:w-1/2 sm:text-sm">
            <p className="">
              We specialise in the providing logisitic for all kinds of Offshore vessels such as AHTS, PSV, Security vessels. Providing engineering service for offshore machinery eg expert in catapillar general overhauling of catapillar , wastila and Rolls Royce engines.
            </p>
            <br />
            <p className="mt-2">
            ...
            <br />
            <p className="mt-2 flex flex-col gap-4" id="service">
             <li>
